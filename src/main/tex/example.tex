% FIDATA Report Example
%
% Written in 2014 by Basil Peace <grv87@yandex.ru>
...
%
% This work bases on erdc sample written in 2008, 2009 by Boris Veytsman
% <borisv@lk.net>, <boris@varphi.com>

\documentclass{fidata-report-template}
\usepackage{lipsum}
\usepackage[main = english, latin]{babel}
\begin{document}
...
\begin{abstract}
  \begin{otherlanguage*}{latin}\lipsum[12-13]\end{otherlanguage*}
\end{abstract}
...
\chapter{Preface}
\begin{otherlanguage*}{latin}\lipsum[1-5]\end{otherlanguage*}
...
\bibliography{fidata-report-template}
